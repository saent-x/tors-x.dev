...
<div
	class="mx-auto flex h-screen w-11/12 max-w-3xl flex-col items-center justify-center gap-4 text-center"
>
	<div>
	...
	<h1 id="header-job-role" class="font-ovo text-3xl sm:text-6xl lg:text-[66px]">fullstack software engineer</h1>
